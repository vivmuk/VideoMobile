...
Roam is a focused, mobile-first Venice video front end. It defaults to Seedance 2.0 Fast for quicker first drafts and keeps model selection out of the first-time creation flow.
...
- If Venice detects a face in a Seedance image-to-video request, Roam shows the exact consent text and asks for the required confirmations before resubmitting.
